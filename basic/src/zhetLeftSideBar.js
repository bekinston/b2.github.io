...
class ZhetLeftSideBar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            allChecked: true,
            list: [
                { id: 3, name: "poi_медная рудаzhet", label: <img src={coru}/>, isChecked: true },
            ]
        };
    }
    ...
    render() {
        return (
            <div id="sidebar" className="dropdown">
                <label className="dropbtn">Жетимшокы</label>
...
export default ZhetLeftSideBar;
