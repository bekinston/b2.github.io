  ...
  'features': [
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            +'<hr>\n' +
            '   <ul>\n' +
            '     <li> ГПП-110/10/6кВ " Анненская "</li>\n' +
            '<li>110/10/6кВ</li>'+
            '   </ul>\n' +
            '   <hr>',
      },
    ...
    },
    {
      ...
      'properties': {
        ...
        'title': 'производство',
        'description':
            '<h1>Балхашская обогатительная фабрика</h1></p>'
            +'<hr>\n' +
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-Kazakhmys_logo.svg.png" alt="Lamp" width="100" height="100" align="center">\n' +
            '     <li style="font-weight: bold">Обогащение :<li> Цветные Металлы </li>\n' +
            '<li style="font-weight: bold">Показатели :<li> Общая производительность 3.3 млн тонн руды в год  </li>'+
            '<li style="font-weight: bold">Переработка контцентратов: :<li>меди</li>'+
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-Kazakhmys_logo.svg.png" alt="Lamp" width="100" height="50"></li>\n' +
            '     <li style="font-weight: bold">Обогащение :<li> Цветные Металлы </li>\n' +
            '<li style="font-weight: bold">Показатели :<li> Общая производительность 1.7 млн тонн руды в год</li>'+
            '<li style="font-weight: bold">Переработка контцентратов: :<li> цинка,меди и пирит</li>'+
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-Kazakhmys_logo.svg.png" alt="Lamp" width="100" height="50"></li>\n' +
            '     <li style="font-weight: bold">Обогащение :<li> Цветные Металлы </li>\n' +
            '<li style="font-weight: bold">Показатели :<li>Общая производительность 4 млн тонн руды в год.</li>'+
            '<li style="font-weight: bold">Переработка контцентратов: :<li> меди </li>'+
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '<li style="font-weight: bold">Показатели :<li> 928.млн кВтч электроэнергии, 793.тыс Гкал теплоэнергии  </li>'+
            '   </ul>\n' +
            '   <hr>'
        ,
        'category':'kazakhmys',
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://tadviser.ru/images/5/50/%D0%90%D0%BB%D1%82%D1%8B%D0%BD%D0%B0%D0%BB%D0%BC%D0%B0%D1%81_%D0%9B%D0%9E%D0%93%D0%9E.png" alt="Lamp" width="100" height="50"></li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://media-exp1.licdn.com/dms/image/C4D0BAQE08gBBoRD_ow/company-logo_200_200/0?e=2159024400&v=beta&t=3bk57xQCVdfZ0XrHpaIzgjz8h4qXxtwodD-NYgtb8XI" alt="Lamp" width="100" height="100"></li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/KAZ_Minerals_logo.svg/1280px-KAZ_Minerals_logo.svg.png" alt="Lamp" width="150" height="50"></li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '     <li style="font-weight: bold">Добыча :<li> Золосодержащая кварцевая руда </li>\n' +
            '<li style="font-weight: bold">Показатели :<li> 6,6 тыс руды  </li>'+
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '     <li style="font-weight: bold">Принадлежность :<li>ОСоО "Глобал Азия Менеджмент"</li>\n' +
            '     <li style="font-weight: bold">Добыча :<li> золото </li>\n' +
            '<li style="font-weight: bold">Показатели :<li> Добыча не ведется  </li>'+
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://kazakhaltyn.kz/assets/images/logo-new-2.png" alt="Lamp" width="150" height="100"></li>\n' +
            '     <li style="font-weight: bold">Добыча :<li> Золото </li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'icon': 'co',
        'description':
            '<h1 style="font-weight: bold"; align="center"; >Сарыадыр</h1></p>'
            +'<hr>\n' +
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-Kazakhmys_logo.svg.png" alt="Lamp" width="100" height="50"></li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'icon': 'co',
        'description':
            '<h1 style="font-weight: bold"; align="center"; >Бурнак</h1></p>'
            +'<hr>\n' +
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-Kazakhmys_logo.svg.png" alt="Lamp" width="100" height="50"></li>\n' +
    ...
    },
    {
      'name': 'медная-цинковая руда',
      'properties': {
        'name': 'Юбилейно-Снегирихинский рудник',
        'title': 'медная-цинковая руда',
        'category':'kazminerals',
        'icon': 'cozn',
        'description':
            '<h1 style="font-weight: bold"; align="center"; >Юбилейно-Снегирихинский рудник</h1></p>'
            +'<hr>\n' +
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/KAZ_Minerals_logo.svg/1280px-KAZ_Minerals_logo.svg.png" alt="Lamp" width="150" height="50"></li>\n' +
    ...
    },
    {
      ...
      'properties': {
        ...
        'description':
            ...
            '   <ul>\n' +
            '     <li style="font-weight: bold">Принадлежность :</li>\n' +
            '     <li style="font-weight: bold"><img src="https://upload.wikimedia.org/wikipedia/ru/thumb/7/7c/Kazakhmys_logo.svg/1200px-C" alt="Lamp" width="100" height="50"></li>\n' +
            '     <li style="font-weight: bold">Добыча :<li> Уголь </li>\n' +
