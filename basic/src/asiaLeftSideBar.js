...
class AsiaLeftSideBar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            allChecked: true,
            list: [
                { id: 2, name: "poi_золотоasia", label: <img src={au}/>,isChecked: true }
            ]
        };
    }
    ...
    render() {
        return (
            <div id="sidebar" className="dropdown">
                <label className="dropbtn">Глобал Азия М</label>
...
export default AsiaLeftSideBar;