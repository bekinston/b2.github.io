...
class DisableAll extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            allChecked: true,
            list: [
                { id: 1, name:'poi_уголь', label: <img src={ug}/>, isChecked: true},
        ...
        return (
            <div id = "sidebar" class="dropdown">
                    <input
                        ...
                        id="checkAll"
                    />
                    <label htmlFor={"checkAll"} onClick={this.state.allChecked}><img src={checkAll}  width={20} height={20}/></label>
